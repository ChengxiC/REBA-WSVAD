...
parser = argparse.ArgumentParser(description='MoeClipVAD')
...
parser.add_argument('--align_coef', default=0.1, type=float)
parser.add_argument('--res_alpha', default=0.1, type=float)
parser.add_argument('--gatelr_rate', default=0.5, type=float)
